...
{if $config.TWOGHZ.status}
																<div class="BlockContent" id="wlan1">
																		<table class="BlockContent" id="table_wlan1">
																				...
																				{input_row label="Import AP List from a file" id="merge_rogue_ap_list0" name="merge_rogue_ap_list0" type="radio" options="1-Replace,0-Merge" selected="==1"}
...
{if $config.FIVEGHZ.status}
																<div  class="BlockContent" id="wlan2">
																		<table class="BlockContent" id="table_wlan2">
																				...
																				{input_row label="Import AP List from a file" id="merge_rogue_ap_list1" name="merge_rogue_ap_list1" type="radio" options="1-Replace,0-Merge" selected="==1"}

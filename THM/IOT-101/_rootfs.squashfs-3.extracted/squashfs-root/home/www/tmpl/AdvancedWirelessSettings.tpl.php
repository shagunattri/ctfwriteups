<?php /* Smarty version 2.6.18, created on 2010-08-06 08:58:40
         compiled from AdvancedWirelessSettings.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'input_row', 'AdvancedWirelessSettings.tpl', 42, false),array('function', 'ip_field', 'AdvancedWirelessSettings.tpl', 82, false),array('modifier', 'default', 'AdvancedWirelessSettings.tpl', 139, false),)), $this); ?>
	<tr>
		<td>
...
<!--@@@CLIENT_SEPARATIONEND@@@-->
	<?php if ($this->_tpl_vars['config']['MAXSTATION_FEATURE']['status']): ?>
											...
											<?php echo smarty_function_input_row(array('label' => "Max. Wireless Clients",'id' => 'maxWirelessClients0','name' => $this->_tpl_vars['parentStr']['wlanSettings']['wlanSettingTable']['wlan0']['maxWirelessClients'],'type' => 'text','value' => $this->_tpl_vars['data']['wlanSettings']['wlanSettingTable']['wlan0']['maxWirelessClients'],'size' => '4','maxlength' => '3','validate' => "Numericality, (( minimum:0, maximum: ".($this->_tpl_vars['maxStationCount']).", onlyInteger: true ))^Presence",'disableCondition' => "5==".($this->_tpl_vars['apMode'])), $this);?>
...
<!--@@@CLIENT_SEPARATIONEND@@@-->
	<?php if ($this->_tpl_vars['config']['MAXSTATION_FEATURE']['status']): ?>
											<?php $this->assign('maxStationCount', $this->_tpl_vars['config']['MAXSTATION']['count']); ?>
											<?php echo smarty_function_input_row(array('label' => "Max. Wireless Clients",'id' => 'maxWirelessClients1','name' => $this->_tpl_vars['parentStr']['wlanSettings']['wlanSettingTable']['wlan1']['maxWirelessClients'],'type' => 'text','value' => $this->_tpl_vars['data']['wlanSettings']['wlanSettingTable']['wlan1']['maxWirelessClients'],'size' => '4','maxlength' => '3','validate' => "Numericality, (( minimum:0, maximum: ".($this->_tpl_vars['maxStationCount']).", onlyInteger: true ))^Presence",'disableCondition' => "5==".($this->_tpl_vars['apMode'])), $this);?>

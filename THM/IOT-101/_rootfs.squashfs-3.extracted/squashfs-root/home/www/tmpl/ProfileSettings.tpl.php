...
<?php if ($this->_tpl_vars['config']['DUAL_CONCURRENT']['status']): ?>
    <?php if (( $this->_tpl_vars['config']['TWOGHZ']['status'] && $this->_tpl_vars['data']['wlanSettings']['wlanSettingTable']['wlan0']['apMode'] == '1' || $this->_tpl_vars['data']['wlanSettings']['wlanSettingTable']['wlan0']['apMode'] == '3' ) && $this->_tpl_vars['data']['wlanSettings']['wlanSettingTable']['wlan0']['radioStatus'] == '1'): ?>
        <input type='hidden' id='formTwoGHzDisable' value='true'>
    <?php else: ?>
        <input type='hidden' id='formTwoGHzDisable' value='false'>
    <?php endif; ?>
    <?php if (( $this->_tpl_vars['config']['FIVEGHZ']['status'] && $this->_tpl_vars['data']['wlanSettings']['wlanSettingTable']['wlan1']['apMode'] == '1' || $this->_tpl_vars['data']['wlanSettings']['wlanSettingTable']['wlan1']['apMode'] == '3' ) && $this->_tpl_vars['data']['wlanSettings']['wlanSettingTable']['wlan1']['radioStatus'] == '1'): ?>

										...
										<table class="BlockContent Trans" id="table_wlan1">
											<tr class="Gray">
												...
												<td class="DatablockContent" style="width: 100%;">
													...
													<input type="radio" style="padding: 2px;" name="WirelessMode1" id="WirelessMode1" <?php if ($this->_tpl_vars['data']['activeMode'] == '1' || $this->_tpl_vars['data']['activeMode0'] == '1' || ( $this->_tpl_vars['data']['activeMode'] == '' && $this->_tpl_vars['defaultMode0'] == '1' )): ?>checked="checked"<?php endif; ?> value="1"><span id="mode_bg" <?php if ($this->_tpl_vars['data']['activeMode'] == '1' || $this->_tpl_vars['data']['activeMode0'] == '1'): ?>class="Active" onmouseover='showLayer(this);' onmouseout='hideLayer(this);'>11bg<img src="../images/activeRadio.gif"><span>Radio is set to 'ON'</span><?php else: ?>>11bg<?php endif; ?></span>
...
" id="activeMode0" value="<?php echo $this->_tpl_vars['data']['activeMode0']; ?>
">
...
<?php endif; ?>
                                                                                        ...
                                                                                        <?php if ($this->_tpl_vars['config']['EXT_CHAN']['status']): ?>
                                                                                            ...
                                                                                            <?php endif; ?>
                                                                                            <tr mode="extCtrl" <?php echo $this->_tpl_vars['hideExtRow']; ?>
 id="extProtSpacRow_1">
...
></td>
												<td class="DatablockContent">
													<input class="input" size="20" id="wepKey1" name="system['staSettings']['staSettingTable']['wlan0']['sta0']['wepKey1']" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['data']['staSettings']['staSettingTable']['wlan0']['sta0']['wepKey1'])) ? $this->_run_mod_handler('regex_replace', true, $_tmp, "/(.)/", '*') : smarty_modifier_regex_replace($_tmp, "/(.)/", '*')); ?>
...
></td>
												<td class="DatablockContent">
													<input class="input" size="20" id="wepKey2" name="system['staSettings']['staSettingTable']['wlan0']['sta0']['wepKey2']" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['data']['staSettings']['staSettingTable']['wlan0']['sta0']['wepKey2'])) ? $this->_run_mod_handler('regex_replace', true, $_tmp, "/(.)/", '*') : smarty_modifier_regex_replace($_tmp, "/(.)/", '*')); ?>
...
></td>
												<td class="DatablockContent">
													<input class="input" size="20" id="wepKey3" name="system['staSettings']['staSettingTable']['wlan0']['sta0']['wepKey3']" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['data']['staSettings']['staSettingTable']['wlan0']['sta0']['wepKey3'])) ? $this->_run_mod_handler('regex_replace', true, $_tmp, "/(.)/", '*') : smarty_modifier_regex_replace($_tmp, "/(.)/", '*')); ?>
...
></td>
												<td class="DatablockContent">
													<input class="input" size="20" id="wepKey4" name="system['staSettings']['staSettingTable']['wlan0']['sta0']['wepKey4']" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['data']['staSettings']['staSettingTable']['wlan0']['sta0']['wepKey4'])) ? $this->_run_mod_handler('regex_replace', true, $_tmp, "/(.)/", '*') : smarty_modifier_regex_replace($_tmp, "/(.)/", '*')); ?>
										...
										<table class="BlockContent Trans" id="table_wlan2">
											<tr class="Gray">
												...
												<td class="DatablockContent" style="width: 100%;">
													...
													<input type="hidden" name="<?php echo $this->_tpl_vars['parentStr']['wlanSettings']['wlanSettingTable']['wlan1']['operateMode']; ?>
" id="activeMode1" value="<?php echo $this->_tpl_vars['data']['activeMode1']; ?>
">
...
">
												<?php endif; ?>
													<input type="hidden" name="modeWlan1" id="modeWlan1" value="<?php if ($this->_tpl_vars['data']['activeMode'] < 3): ?>4<?php else: ?><?php echo $this->_tpl_vars['data']['activeMode']; ?>
<?php endif; ?>">
												</td>
											</tr>
                                                                                        <?php if ($this->_tpl_vars['config']['SCH_WIRELESS_ON_OFF']['status']): ?>

<?php /* Smarty version 2.6.18, created on 2010-07-19 06:40:08
         compiled from vapSecurityProfile.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'input_row', 'vapSecurityProfile.tpl', 42, false),array('function', 'ip_field', 'vapSecurityProfile.tpl', 73, false),array('modifier', 'regex_replace', 'vapSecurityProfile.tpl', 93, false),)), $this); ?>
...
" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['data']['wepPassPhrase'])) ? $this->_run_mod_handler('regex_replace', true, $_tmp, "/(.)/", '*') : smarty_modifier_regex_replace($_tmp, "/(.)/", '*')); ?>
...
" onkeydown="setActiveContent();" masked="true" onchange="this.setAttribute('masked',(this.value != '')?false:true); $('wepPassPhrase_hidden').value='';">&nbsp;
									...
									<input type="hidden" id="wepPassPhrase_hidden" value="<?php echo $this->_tpl_vars['data']['wepPassPhrase']; ?>
">
								</td>
							</tr>
							<tr mode="1" <?php echo $this->_tpl_vars['hideWepRow']; ?>
...
']['wepKey1']" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['data']['wepKey1'])) ? $this->_run_mod_handler('regex_replace', true, $_tmp, "/(.)/", '*') : smarty_modifier_regex_replace($_tmp, "/(.)/", '*')); ?>
...
']['vap<?php echo $this->_tpl_vars['navigation']['7']; ?>
']['wepKey2']" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['data']['wepKey2'])) ? $this->_run_mod_handler('regex_replace', true, $_tmp, "/(.)/", '*') : smarty_modifier_regex_replace($_tmp, "/(.)/", '*')); ?>
...
']['vap<?php echo $this->_tpl_vars['navigation']['7']; ?>
']['wepKey3']" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['data']['wepKey3'])) ? $this->_run_mod_handler('regex_replace', true, $_tmp, "/(.)/", '*') : smarty_modifier_regex_replace($_tmp, "/(.)/", '*')); ?>
...
']['vap<?php echo $this->_tpl_vars['navigation']['7']; ?>
']['wepKey4']" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['data']['wepKey4'])) ? $this->_run_mod_handler('regex_replace', true, $_tmp, "/(.)/", '*') : smarty_modifier_regex_replace($_tmp, "/(.)/", '*')); ?>
...
>
								...
								<td class="DatablockContent">
                                                                <input type="hidden" id="wpa_psk_hidden" value="<?php echo $this->_tpl_vars['data']['presharedKey']; ?>
">
<?php if ($this->_tpl_vars['config']['WN604']['status']): ?>
									<input id="wpa_psk" class="input" size="28" maxlength="63" name="<?php echo $this->_tpl_vars['parentStr']['presharedKey']; ?>
" value="<?php if ($this->_tpl_vars['wpsDisable'] == '1'): ?><?php echo ((is_array($_tmp=$this->_tpl_vars['data']['presharedKey'])) ? $this->_run_mod_handler('regex_replace', true, $_tmp, "/(.)/", '*') : smarty_modifier_regex_replace($_tmp, "/(.)/", '*')); ?>
<?php else: ?><?php echo $this->_tpl_vars['data']['presharedKey']; ?>
...
/.test(this.value)) this.value='';setActiveContent();">
    <?php else: ?>
                                                                        <input id="wpa_psk" class="input" size="28" maxlength="63" name="<?php echo $this->_tpl_vars['parentStr']['presharedKey']; ?>
" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['data']['presharedKey'])) ? $this->_run_mod_handler('regex_replace', true, $_tmp, "/(.)/", '*') : smarty_modifier_regex_replace($_tmp, "/(.)/", '*')); ?>
...
" value="<?php if ($this->_tpl_vars['wpsDisable'] == '1'): ?><?php echo ((is_array($_tmp=$this->_tpl_vars['data']['wpaPsk'])) ? $this->_run_mod_handler('regex_replace', true, $_tmp, "/(.)/", '*') : smarty_modifier_regex_replace($_tmp, "/(.)/", '*')); ?>
<?php else: ?><?php echo $this->_tpl_vars['data']['wpaPsk']; ?>
<?php endif; ?>" onfocus="if(/^\*<?php echo '{1,}$'; ?>

<?php /* Smarty version 2.6.18, created on 2010-07-06 08:50:36
...
<?php if ($this->_tpl_vars['config']['TWOGHZ']['status']): ?>
																<div class="BlockContent" id="wlan1">
																		<table class="BlockContent" id="table_wlan1">
																				...
																				<?php echo smarty_function_input_row(array('label' => 'Import AP List from a file','id' => 'merge_rogue_ap_list0','name' => 'merge_rogue_ap_list0','type' => 'radio','options' => "1-Replace,0-Merge",'selected' => "==1"), $this);?>
																...
																<div  class="BlockContent" id="wlan2">
																		<table class="BlockContent" id="table_wlan2">
																				<?php echo smarty_function_input_row(array('label' => 'Turn Rogue AP Detection On','id' => 'rogueApDetection1','name' => $this->_tpl_vars['parentStr']['wlanSettings']['wlanSettingTable']['wlan1']['rogueApDetection'],'type' => 'checkbox','value' => $this->_tpl_vars['data']['wlanSettings']['wlanSettingTable']['wlan1']['rogueApDetection'],'selectCondition' => "!=0",'size' => '16','maxlength' => '15'), $this);?>
                                                       														<?php echo smarty_function_input_row(array('label' => 'Rogue AP Detection Policy','id' => 'rogueApDetectionPolicy1','name' => $this->_tpl_vars['parentStr']['wlanSettings']['wlanSettingTable']['wlan1']['rogueApDetectionPolicy'],'type' => 'select', 'options' => $rogueAp_detection_policy, 'selected' => $this->_tpl_vars['data']['wlanSettings']['wlanSettingTable']['wlan1']['rogueApDetectionPolicy'] ), $this);?>
																				<?php echo smarty_function_input_row(array('label' => 'Import AP List from a file','id' => 'merge_rogue_ap_list1','name' => 'merge_rogue_ap_list1','type' => 'radio','options' => "1-Replace,0-Merge",'selected' => "==1"), $this);?>

...
case "$1" in
	...
	;;
	12)
	echo "EST-10EDT,M10.1.0/3:00:00,M4.1.0/3:00:00" > /etc/TZ
	export "TZ=EST-10EDT,M10.1.0/3:00:00,M4.1.0/3:00:00"
	;;
	13)
	...
	;;
	15)
	echo "CST-9:30CDT,M10.1.0/3:00:00,M4.1.0/3:00:00" > /etc/TZ
	export "TZ=CST-9:30CDT,M10.1.0/3:00:00,M4.1.0/3:00:00"
	;;
	16)
	echo "EST-10EDT,M10.1.0/3:00:00,M4.1.0/3:00:00" > /etc/TZ
	export "TZ=EST-10EDT,M10.1.0/3:00:00,M4.1.0/3:00:00"
	...
	export "TZ=EET-2CEST,M3.5.0/4:00:00,M10.5.0/4:00:00"
	;;
	97)
	...
	;;
	117)
	echo "GMT0IST,M3.5.0/2:00:00,M10.5.0/2:00:00" > /etc/TZ
	export "TZ=GMT0IST,M3.5.0/2:00:00,M10.5.0/2:00:00"
	;;
	118)
	...
	;;
	171)
	echo "NZST-12NZDT,M9.5.0/3:00:00,M4.1.0/3:00:00" > /etc/TZ
	export "TZ=NZST-12NZDT,M9.5.0/3:00:00,M4.1.0/3:00:00"
	;;
	172)
	echo "CHAST-12:45CHADT,M9.5.0/02:45:00,M4.1.0/03:45:00" > /etc/TZ
	export "TZ=CHAST-12:45CHADT,M9.5.0/02:45:00,M4.1.0/03:45:00"
	;;
	173)
	echo "CST6" > /etc/TZ
	export "TZ=CST6"
	...
	;;
	196)
	echo "MSK-3MSD,M3.5.0/3:00:00,M10.5.0/3:00:00" > /etc/TZ
	export "TZ=MSK-3MSD,M3.5.0/3:00:00,M10.5.0/3:00:00"
	;;
	197)
	echo "EET-2EEST,M3.5.0/3:00:00,M10.5.0/3:00:00" > /etc/TZ
	export "TZ=EET-2EEST,M3.5.0/3:00:00,M10.5.0/3:00:00"
	...
	;;
	206)
	echo "0,M3.5.0/3:00:00,M10.5.0/3:00:00" > /etc/TZ
	export "TZ=0,M3.5.0/3:00:00,M10.5.0/3:00:00"
	;;
	207)
	...
	;;
	255)
	echo "GMT0BST,M3.5.0/2:00:00,M10.5.0/2:00:00" > /etc/TZ
	export "TZ=GMT0BST,M3.5.0/2:00:00,M10.5.0/2:00:00"
	;;
	256)

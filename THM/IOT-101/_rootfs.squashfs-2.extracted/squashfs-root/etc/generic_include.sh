...
TRANSLATORS="syslog password ssh snmp telnet dns bridge_and_vlan_translator hostapd_tr nmbd_tr http_redirect_tr ethtool_tr dhcp ntp timezone sc_radio"
AP_MODE_TRANSLATORS="syslog password ssh snmp telnet dns client_bridge_tr  nmbd_tr ethtool_tr dhcp ntp timezone sc_radio"

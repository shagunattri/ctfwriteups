					...
					<td class="spacer100Percent paddingsubSectionBody">
						<table class="tableStyle">
							<tr>
								...
								<td class="DatablockLabel">{ip_field id="untaggedvlan" name=$parentStr.basicSettings.untaggedVlanStatus type="checkbox" value="1" selectCondition="==$untaggedVlanStatus" onclick="fetchObjectById('untaggedvlanid').disabled=!this.checked;"}&nbsp;Untagged VLAN</td>

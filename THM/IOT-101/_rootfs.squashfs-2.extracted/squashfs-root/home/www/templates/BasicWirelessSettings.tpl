											...
											<td>
												<ul class="inlineTabs">
													{if $config.TWOGHZ.status}
														<li id="inlineTab1" {if $data.activeMode eq '2' OR $data.activeMode eq '1' OR $data.activeMode eq '0' OR $data.activeMode0 eq '0' OR $data.activeMode0 eq '1' OR $data.activeMode0 eq '2'}class="Active" activeRadio="true"{else} activeRadio="false"{/if} currentId="1"><a id="inlineTabLink1" href="javascript:void(0)">802.11<span class="Active" onmouseover='showLayer(this);' onmouseout='hideLayer(this);'><b class="RadioText{if $data.activeMode eq '0' OR $data.activeMode0 eq '0'}Active{/if}">b{if $data.activeMode eq '0' OR $data.activeMode0 eq '0'}<img src="../images/activeRadio.gif"><span>Radio is set to 'ON'</span>{/if}</b></span>{if $config.MODE11G.status}/<span class="Active" onmouseover='showLayer(this);' onmouseout='hideLayer(this);'><b class="RadioText{if $data.activeMode eq '1' OR $data.activeMode0 eq '1'}Active{/if}">bg{if $data.activeMode eq '1' OR $data.activeMode0 eq '1'}<img src="../images/activeRadio.gif"><span>Radio is set to 'ON'</span>{/if}</b></span>{/if}{if $config.MODE11N.status}/<span class="Active" onmouseover='showLayer(this);' onmouseout='hideLayer(this);'><b class="RadioText{if $data.activeMode eq '2' OR $data.activeMode0 eq '2'}Active{/if}">ng{if $data.activeMode eq '2' OR $data.activeMode0 eq '2'}<img src="../images/activeRadio.gif"><span>Radio is set to 'ON'</span>{/if}</b></span>{/if}</a></li>
													{/if}
<!--@@@FIVEGHZSTART@@@-->
													{if $config.FIVEGHZ.status}
														<li id="inlineTab2" {if $data.activeMode eq '3' OR $data.activeMode eq '4' OR $data.activeMode1 eq '3' OR $data.activeMode1 eq '4'}class="Active" activeRadio="true"{else} activeRadio="false"{/if} currentId="2"><a id="inlineTabLink2" href="javascript:void(0)">802.11<span class="Active" onmouseover='showLayer(this);' onmouseout='hideLayer(this);'><b class="RadioText{if $data.activeMode eq '3' OR $data.activeMode1 eq '3'}Active{/if}">a{if $data.activeMode eq '3' OR $data.activeMode1 eq '3'}<img src="../images/activeRadio.gif"><span>Radio is set to 'ON'</span>{/if}</b></span>{if $config.MODE11N.status}/<span class="Active" onmouseover='showLayer(this);' onmouseout='hideLayer(this);'><b class="RadioText{if $data.activeMode eq '4' OR $data.activeMode1 eq '4'}Active{/if}">na{if $data.activeMode eq '4' OR $data.activeMode1 eq '4'}<img src="../images/activeRadio.gif"><span>Radio is set to 'ON'</span>{/if}</b></span>{/if}</a></li>
													{/if}
<!--@@@FIVEGHZEND@@@-->
												</ul>
											</td>

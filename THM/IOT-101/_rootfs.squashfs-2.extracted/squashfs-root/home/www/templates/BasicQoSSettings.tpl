...
<!--@@@FIVEGHZSTART@@@-->
										...
										<div class="BlockContent" id="wlan2">
											<table class="BlockContent" id="table_wlan2">
												...
												{input_row label="Enable Wi-Fi Multimedia (WMM)" id="idwmmSupport1" name=$parentStr.wlanSettings.wlanSettingTable.wlan1.wmmSupport type="radio" options="1-Enable,0-Disable" selectCondition="==$wmmSupport"}
												{if $config.WMM.WMM_PS.status}
												{assign var="uapsdStatus" value=$data.wlanSettings.wlanSettingTable.wlan1.uapsdStatus}
												{input_row label="WMM Powersave" id="idwmmPowersave1" name=$parentStr.wlanSettings.wlanSettingTable.wlan1.uapsdStatus type="radio" options="1-Enable,0-Disable" selectCondition="==$uapsdStatus"}
												{/if}
											</table>
										</div>
										{/if}

<?php /* Smarty version 2.6.18, created on 2010-08-18 09:53:26
...
<?php if ($this->_tpl_vars['config']['TWOGHZ']['status'] && $this->_tpl_vars['data']['radioStatus0'] == '1'): ?>
 ...
 Radio</th>
												<td><?php echo $this->_tpl_vars['data']['monitor']['radioApStatus']['wlan0']['numberOfStations']; ?>
</td>
											</tr>
<?php endif; ?>
<?php if ($this->_tpl_vars['config']['FIVEGHZ']['status'] && $this->_tpl_vars['data']['radioStatus1'] == '1'): ?>
											<tr class="Alternate">
												<th>802.11na Radio</th>
												<td class="Alternate"><?php echo $this->_tpl_vars['data']['monitor']['radioApStatus']['wlan1']['numberOfStations']; ?>
</td>
    											</tr>
<?php endif; ?>
										</table>
